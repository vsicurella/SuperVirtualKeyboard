...
void PluginControlComponent::resized()
{
    ...
    scaleEntryBtn->setBounds (((getWidth() / 2) + -26 - (proportionOfWidth (0.1923f) / 2)) + proportionOfWidth (0.1923f) - -34 - 31, 16, 31, 24);
    periodShiftSld->setBounds (22 + proportionOfWidth (0.1075f) - -76 - 86, getHeight() - 48, 86, 24);
    ...
    midiChannelSld->setBounds (((22 + proportionOfWidth (0.1075f) - -76 - 86) + 86 - 1) + proportionOfWidth (0.1075f), getHeight() - 48, proportionOfWidth (0.0968f), 24);
    midiChannelLbl->setBounds ((22 + proportionOfWidth (0.1075f) - -76 - 86) + 86 - 1, getHeight() - 48, proportionOfWidth (0.1075f), 24);
    noteNumsBtn->setBounds ((((22 + proportionOfWidth (0.1075f) - -76 - 86) + 86 - 1) + proportionOfWidth (0.1075f)) + proportionOfWidth (0.0968f) - -3, getHeight() - 48, 24, 24);
    periodShiftLbl->setBounds (22, getHeight() - 48, proportionOfWidth (0.1075f), 24);
    editColorsBtn->setBounds ((((((((22 + proportionOfWidth (0.1075f) - -76 - 86) + 86 - 1) + proportionOfWidth (0.1075f)) + proportionOfWidth (0.0968f) - -3) + 24 - -6) + proportionOfWidth (0.1422f) - -6) + proportionOfWidth (0.1075f) - -10) + 88 - -8, getHeight() - 47, proportionOfWidth (0.0956f), 16);
    keyStyleBox->setBounds (((((22 + proportionOfWidth (0.1075f) - -76 - 86) + 86 - 1) + proportionOfWidth (0.1075f)) + proportionOfWidth (0.0968f) - -3) + 24 - -6, getHeight() - 49, proportionOfWidth (0.1422f), 24);
    mapStyleLbl->setBounds (76 - (104 / 2), 48, 104, 24);
    highlightStyleBox->setBounds ((((((22 + proportionOfWidth (0.1075f) - -76 - 86) + 86 - 1) + proportionOfWidth (0.1075f)) + proportionOfWidth (0.0968f) - -3) + 24 - -6) + proportionOfWidth (0.1422f) - -6, getHeight() - 48, proportionOfWidth (0.1075f), 24);
    keyboardViewport->setBounds (24, 80, getWidth() - 48, getHeight() - 132);
    settingsButton->setBounds (((((((22 + proportionOfWidth (0.1075f) - -76 - 86) + 86 - 1) + proportionOfWidth (0.1075f)) + proportionOfWidth (0.0968f) - -3) + 24 - -6) + proportionOfWidth (0.1422f) - -6) + proportionOfWidth (0.1075f) - -10, getHeight() - 47, 88, 16);
    mapOrderEditBtn->setBounds (400 - 96, 48, 96, 24);
    mapModeBox->setBounds (136, 16, proportionOfWidth (0.1589f), 24);
    scaleTextBox->setBounds ((getWidth() / 2) + -26 - (proportionOfWidth (0.1923f) / 2), 16, proportionOfWidth (0.1923f), 24);
    modeInfoButton->setBounds (((getWidth() / 2) + -26 - (proportionOfWidth (0.1923f) / 2)) + proportionOfWidth (0.1923f) / 2 + -116, 16, 24, 24);
...
<JUCER_COMPONENT documentType="Component" className="PluginControlComponent" componentName=""
  ...
  <SLIDER name="Period Shift Slider" id="89742a2afd3a3325" memberName="periodShiftSld"
          virtualName="" explicitFocusOrder="0" pos="-76Rr 48R 86 24" posRelativeX="140764aae2291735"
  ...
  <SLIDER name="Midi Channel Slider" id="4f2d4d8b9051247f" memberName="midiChannelSld"
          virtualName="" explicitFocusOrder="0" pos="0R 48R 9.677% 24"
  ...
  <LABEL name="Midi Channel Label" id="d2587185be475d9c" memberName="midiChannelLbl"
         virtualName="" explicitFocusOrder="0" pos="1R 48R 10.753% 24"
  ...
  <TEXTBUTTON name="Note Numbers Button" id="405a79d645f5f8ac" memberName="noteNumsBtn"
              virtualName="" explicitFocusOrder="0" pos="-3R 48R 24 24" posRelativeX="4f2d4d8b9051247f"
              buttonText="#" connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <LABEL name="Period Shift Label" id="140764aae2291735" memberName="periodShiftLbl"
         virtualName="" explicitFocusOrder="0" pos="22 48R 10.753% 24"
         edTextCol="ff000000" edBkgCol="0" labelText="Period Shift" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15.0" kerning="0.0" bold="0" italic="0" justification="33"/>
  <TEXTBUTTON name="Edit Colors Button" id="bc86137b1b6a5176" memberName="editColorsBtn"
              virtualName="" explicitFocusOrder="0" pos="-8R 47R 9.558% 16"
              posRelativeX="70f30d2c8f0f81a0" buttonText="Edit Colors" connectedEdges="0"
              needsCallback="1" radioGroupId="0"/>
  <COMBOBOX name="Key Style Box" id="292b32e0c6cd0b80" memberName="keyStyleBox"
            virtualName="" explicitFocusOrder="0" pos="-6R 49R 14.217% 24"
  ...
  <COMBOBOX name="Highlight Style Box" id="ddae7c4ef2fca8a5" memberName="highlightStyleBox"
            virtualName="" explicitFocusOrder="0" pos="-6R 48R 10.753% 24"
  ...
  <TEXTBUTTON name="Settings Button" id="70f30d2c8f0f81a0" memberName="settingsButton"
              virtualName="" explicitFocusOrder="0" pos="-10R 47R 88 16" posRelativeX="ddae7c4ef2fca8a5"
  ...
  <COMBOBOX name="Mapping Node Box" id="76c96eb48f8092a" memberName="mapModeBox"
            virtualName="" explicitFocusOrder="0" pos="136 16 15.89% 24"
  ...
  <TEXTEDITOR name="Scale Text Box" id="39f9f4bff4e94802" memberName="scaleTextBox"
              virtualName="" explicitFocusOrder="0" pos="-25.5Cc 16 19.235% 24"
